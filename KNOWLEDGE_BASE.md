...
```mermaid
classDiagram
  class app_py_OptimizedE8Layer {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +cross_validate_model(model_class, X, y, edge_index, num_nodes, n_splits, seed, name)
    +__init__(self, in_features, out_features, edge_index, num_nodes)
    +forward(self, x)
    +__init__(self, input_dim, hidden_dim, edge_index, num_nodes, dropout)
    +forward(self, x, edge_index)
    +__init__(self, input_dim, hidden_dim, edge_index, num_nodes, dropout)
    +forward(self, x, edge_index)
    +__init__(self, input_dim, hidden_dim, edge_index, num_nodes, dropout)
  }
  class app_py_RESMAv2Fast {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +cross_validate_model(model_class, X, y, edge_index, num_nodes, n_splits, seed, name)
  ...
  class app_timestamp_py_OptimizedE8Layer {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +temporal_cross_validate_model(model_class, X, y, edge_index, timestep, num_nodes, name, min_train_ts)
    +__init__(self, in_features, out_features, edge_index, num_nodes)
    +forward(self, x)
    +__init__(self, input_dim, hidden_dim, edge_index, num_nodes, dropout)
    +forward(self, x, edge_index)
  ...
  class app_timestamp_py_RESMAv2Fast {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +temporal_cross_validate_model(model_class, X, y, edge_index, timestep, num_nodes, name, min_train_ts)
  ...
  class app_timestamp_py_RESMAv2Standard {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +temporal_cross_validate_model(model_class, X, y, edge_index, timestep, num_nodes, name, min_train_ts)
  ...
  class app_timestamp_py_RESMAv2Deep {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +temporal_cross_validate_model(model_class, X, y, edge_index, timestep, num_nodes, name, min_train_ts)
  ...
  class app_timestamp_py_GAT_Baseline {
    <<class>>
    +load_elliptic_data()
    +train_and_evaluate(model, X, y, edge_index, train_idx, val_idx, epochs, lr, name, fold)
    +temporal_cross_validate_model(model_class, X, y, edge_index, timestep, num_nodes, name, min_train_ts)
